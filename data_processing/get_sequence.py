...
with open('/mnt/workspace/replicate/Struct2GO/processed_data/protein_node2onehot','wb')as f:
    pickle.dump(protein_node2one_hot,f)
with open('/mnt/workspace/replicate/Struct2GO/processed_data/protein_sequence','wb')as f:
